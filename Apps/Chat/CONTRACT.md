...
(`Apps/Chat/android/chatkit`) land in a later C3-28 implementation stage and
...
generated by the sending client's own message-ID generation at `send()`
time (128-bit, same generation mechanism a live client would use — out of
scope for this document to pin further).
